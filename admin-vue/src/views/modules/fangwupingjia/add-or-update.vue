...
export default {
  ...
  methods: {
	...
	this.ruleForm.fangwupingjia = this.ruleForm.fangwupingjia.replace(reg,'../../../leasehouses/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
